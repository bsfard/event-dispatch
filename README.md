...
python -m pip install "eventdispatch @ git+https://github.com/bsfard/event-dispatch.git@v0.0.7"
...
# Pin to a release tag.
eventdispatch @ git+https://github.com/bsfard/event-dispatch.git@v0.0.7
